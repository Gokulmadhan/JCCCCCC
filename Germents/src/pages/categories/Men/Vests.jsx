  ...
  const fetchVests = async () => {
    try {
      ...
      const filtered = res.data
        .filter(p => p.category === "Men" && p.subcategory === "Vests")
        .map(p => ({
          ...p,
      ...
      console.error("Error fetching vests:", err);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-12 text-center">
        <motion.h1
          ...
          data-aos="zoom-in"
        >
          Essential Vest Collection
        </motion.h1>
        <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
          Premium comfort and style - explore our range of high-quality vests for men
        </p>
      </div>
            ...
            {products.map((product, idx) => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  {product.offer && (
                    <div className="absolute top-4 right-4 bg-blue-700 text-white text-xs font-bold px-2 py-1 rounded-full uppercase">
                      {product.offer}
                    </div>
                  )}
                </div>
      ...
      {!isLoading && products.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No vests found</h3>
