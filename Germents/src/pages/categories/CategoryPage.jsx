...
const {gender,type}=useParams();
  ...
  const fetchProducts = async () => {
    try {
      setIsLoading(true);
      const res = await axios.get(`${backend_url}/products`,{ params: {
      category:  gender,
      subcategory:type
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-12 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
          Train hard, stay comfortable — explore our high-performance  for {`${gender}`}.
        </p>
      </div>
      ...
      {!isLoading && products.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No  found</h3>
