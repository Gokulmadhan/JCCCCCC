  ...
  const fetchProducts = async () => {
    try {
      ...
      const updated = res.data
        .filter((p) => p.category === "Women" && p.subcategory === "Vests")
        .map((p) => ({
          ...p,
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-12 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
          Discover our collection of stylish and comfortable vests for women
        </p>
      </div>
      ...
      {products.length > 0 && (
        <motion.button
          className="mt-14 mx-auto block bg-black text-white px-10 py-3 rounded-md text-sm font-medium hover:bg-green-700 transition"
