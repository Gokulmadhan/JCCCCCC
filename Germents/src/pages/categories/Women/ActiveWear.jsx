...
const filterData=()=>{
    const res=items.filter((item)=>item.category=='women'&&item.subcategory=='activewear')
    setProducts(res);
  }
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-12 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
          Train hard, stay comfortable — explore our high-performance activewear for women.
        </p>
      </div>
      ...
      {!isLoading && products.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No activewear found</h3>
